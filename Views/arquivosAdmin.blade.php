      ...
      <nav aria-label="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-12 text-left mb-1">
              <a class="btn btn-success" href="../enviaArquivosAdmin/{{$id_para}}" role="button">ENVIAR ARQUIVO</a>
            </div>
        </div>          
        <div class="row">
        <div class="col-md-12 ">
            ...
            <div class="table-responsive">
                ...
                <ul class="pagination justify-content-center mb-4">
                  ...
                  <li class="page-item"><a class="page-link" style="color: #2c3e50;" href="http://localhost:8888/projetocomun/admin/arquivosAdmin/{{$id_para}}?p={{$q+1}}">{{$q+1}}</a></li>
