...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
			...
			?>	
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item items-align" href="https://projetocomun.com/usuario/arquivosrecebidosusuario/<?php echo $_SESSION['login'] ?>">Novos Arquivos
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item items-align" href="https://projetocomun.com/admin/notificacoes">Novos Arquivos
						<?php if ( $_SESSION['unreadFiles']) {?>
							<span class="badge badge-pill badge-secondary"><?php echo $_SESSION['unreadFiles'] ?></span></a>
						<?php 
						}
