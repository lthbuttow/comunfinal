...
<head>
  ...
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css">
	...
	<link rel="stylesheet" type="text/css" href="https://projetocomun/assets/css/style.css">
</head>
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				?>
				<li class="nav-item">
					<a class="nav-link" href="https://projetocomun/login/logout" id="scrollSuave">Logout</a>
				</li>
				<?php	
				} 
				?>
...
<script type="text/javascript" src="https://projetocomun/assets/js/script.js"></script>	
</body>
</html>