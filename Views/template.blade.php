...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
		...
		<?php if( isset($_SESSION['admin']) ){ ?>	
			<a class="navbar-brand" href="http://localhost:8888/projetocomun/admin">Comun.</a>
		<?php
		}
		else {
		?>
			<a class="navbar-brand" href="http://localhost:8888/projetocomun/usuario">Comun.</a>
		<?php	
		} 
		?>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item items-align" href="http://localhost:8888/projetocomun/admin/notificacoes">Novos Arquivos
						...
						?>
					<a class="dropdown-item" href="http://localhost:8888/projetocomun/admin/usuariosDesativados">Usuários Desativados</a>		
          <a class="dropdown-item" href="http://localhost:8888/projetocomun/log/log.txt" download>Baixar Logs</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="http://localhost:8888/projetocomun/login/logout" id="scrollSuave">Logout</a>
        </div>
      </li>
