      ...
      <div class="container my-auto">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <a href="http://localhost/projetocomun/admin/listagemUsuarios"><i class="fas fa-4x fa-id-card text-orange mb-3 sr-icon-3"></i>
          ...
          <div class="col-lg-6 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <a href="http://localhost/projetocomun/admin/mensagem"><i class="fas fa-4x fa-envelope text-orange mb-3 sr-icon-4"></i>
