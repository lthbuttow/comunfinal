    ...
    <article class="mastheads text-center text-white d-flex">
      <div class="container my-auto">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <a href="http://localhost:8888/projetocomun/admin/listagemUsuarios"><i class="fas fa-4x fa-id-card text-orange mb-3 sr-icon-3"></i>
              <h4 class="mb-3">Menu de Usuários</h4></a>
              <?php 
                // $qtd_arquivos = $arquivo->getStatus();
                $qtd_arquivos = 3;
          ...
          <div class="col-lg-6 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <a href="http://localhost:8888/projetocomun/admin/mensagem"><i class="fas fa-4x fa-envelope text-orange mb-3 sr-icon-4"></i>
              <h4 class="mb-3">Mensagens</h4></a>
              <p class="text-muted mb-0">Você tem {{ $nrMsgs }} mensagens a serem visualizadas</p>
            </div>
          </div>
